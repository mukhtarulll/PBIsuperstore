...
**Format Dokumentasi:**
- README.md: overview proyek, dataset, insight, dan file pendukung
- BI-methodology.md: dokumentasi teknis tahapan kerja (file ini)
- Screenshot dashboard dan diagram model data
- Export dashboard ke PDF untuk preview cepat
- File queries.sql untuk validasi SQL

### 8. File Pendukung dalam Repository
Struktur file untuk portfolio GitHub:
```
├── README.md
├── BI-methodology.md
...
### Tools & Technologies
- **Power BI Desktop:** Data modeling, DAX, visualisasi
- **Power Query:** ETL dan data cleaning
- **SQL (SQLite/PostgreSQL):** Validasi dan agregasi data
- **Excel:** Sanity check dan EDA awal
- **Git/GitHub:** Version control dan portfolio hosting

### Timeline Pengerjaan
- Hari 1: Data sourcing, cleaning, model design (4–5 jam)
- Hari 2: DAX measures, dashboard build, insight generation (4–5 jam)
- Hari 3: Dokumentasi, export, polish, upload ke GitHub (2–3 jam)

Total: 10–13 jam untuk proyek portfolio entry-level yang komprehensif.

---

**Catatan:**
Metodologi ini mengikuti best practice BI/DA untuk reproducibility, transparency, dan business value. Setiap tahap terdokumentasi untuk memudahkan reviewer memahami proses dari raw data hingga actionable insight.